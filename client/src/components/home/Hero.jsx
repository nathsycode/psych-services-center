  ...
  return (
    <section ref={ref} className="relative py-20 lg`py-28 overflow-hidden w-full h-dvh flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="inline-flex items-center space-x-2 bg-primary/10 text-slate-200 px-4 py-2 rounded-full text-sm font-medium mb-6 hover:bg-primary/20 transition-colors">
