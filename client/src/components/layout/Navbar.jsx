      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <Link
              to="/booking"
              className="inline-block bg-primary text-white px-6 py-2 rounded-lg font-medium hover:bg-accent transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
              Book Now
            </Link>
          </div>
